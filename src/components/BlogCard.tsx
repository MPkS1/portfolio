...
const categoryColors: Record<string, string> = {
  ...
  Systems: "bg-green-100 dark:bg-green-950/50 text-green-700 dark:text-green-300",
  Mobile: "bg-orange-100 dark:bg-orange-950/50 text-orange-700 dark:text-orange-300",
};
