...
export const projects: Project[] = [
  ...
  },
  {
    ...
    description: "Full-stack real-time chat application with JWT authentication, live messaging via Socket.io, and global state management.",
    longDescription: "A production-quality chat platform built on the MERN stack (MongoDB, Express.js, React, Node.js). It features JWT-based authentication, real-time bidirectional messaging powered by Socket.io, online user status indicators, and global state management with Zustand. The UI is styled with Tailwind CSS and Daisy UI for a polished, responsive experience. Comprehensive error handling is implemented on both client and server.",
